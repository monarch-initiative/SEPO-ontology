 ...
 * [sepio.yml](sepio.yml)
     * Determines how your purl.obolibrary.org/obo/sepio/ redirects will be handled
     ...
     * Paste in the contents of [sepio.yml](sepio.yml)
 ...
 * [sepio.md](sepio.md)
     ...
     * Paste in the contents of [sepio.md](sepio.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
