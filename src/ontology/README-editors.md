These notes are for the EDITORS of sepio
...
Make sure you have an ID range in the [idranges file](sepio-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [sepio-edit.owl](sepio-edit.owl)

** DO NOT EDIT sepio.obo OR sepio.owl in the top level directory **

[../../sepio.owl](../../sepio.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch-initiative/SEPIO-ontology) for details.
 ...
 * [sepio-idranges.owl](sepio-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/sepio_terms.txt file
...
Note: the sepio_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as sepio.owl and sepio.obo and places
 ...
 * https://github.com/monarch-initiative/SEPIO-ontology/releases
 * https://github.com/monarch-initiative/SEPIO-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived sepio.owl (`data-version` in
sepio.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/sepio.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/sepio/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch-initiative/SEPIO-ontology.svg?branch=master)](https://travis-ci.org/monarch-initiative/SEPIO-ontology)
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to SEPIO-ontology
