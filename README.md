...
***NOTICE:*** THE SEPIO ONTOLOGY IS IN ITS EARLY STAGES OF DEVLEOPMENT, THE MODEL IS BEING ITERATIVLY REFINED AS NEW REQUIREMENTS EMERGE AND WE EXPLORE ALIGNMENT WITH AND RE-USE OF EXISTING STANDARDS.  WE WELCOME ANY FEEDBACK YOU MAY HAVE, IN THE FORM OF USE CASES, EXEMPLAR DATA, AND REQUIREMENTS. PLEASE SUBMIT TO OUR TRACKER [HERE](https://github.com/monarch-initiative/SEPIO-ontology/issues).  
